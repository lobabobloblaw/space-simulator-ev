...
- WebGL Spike (2025-08): added behind a flag; **removed 2026-09** — the frame is dominated by Canvas2D-fixable costs (star tiles, gradient caching) and entity counts sit far below the batching threshold. See `TICKET_WEBGL_SPIKE.md`.
